...
export class DIContainer {
  ...
  private constructor() {
    ...
    this._executeSwapUseCase = new ExecuteSwapUseCase(this._swapDomainService);
    this._getSwapHistoryUseCase = new GetSwapHistoryUseCase(this._swapDomainService);
    ...
    console.log("[DIContainer] Dependency injection container initialized successfully");
  }
